...
function vRP.CheckDamaged(Item)
	-- Pega o nome base do item (remove timestamp se tiver)
	local itemName = SplitOne(Item)

	-- Se NÃO for mochila, nunca considera danificado
	if not BackpackItems[itemName] then
		return false
	end
