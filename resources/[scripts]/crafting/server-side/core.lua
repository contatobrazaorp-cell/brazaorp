...
-----------------------------------------------------------------------------------------------------------------------------------------
-- HAS PERMISSION (USADO PELO CLIENT PRA FACÇÃO / GROUPS)
-- EXEMPLO: "MEDELLIN", "MAGNATAS", "CARTEL"...
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.HasPermission(Perm)
	local source = source
	local Passport = vRP.Passport(source)
	if Passport and Perm then
		return vRP.HasService(Passport,Perm)
	end
	return false
end

-----------------------------------------------------------------------------------------------------------------------------------------
-- PERMISSION (SEU SISTEMA ATUAL DO CRAFTING - MANTIDO)
-----------------------------------------------------------------------------------------------------------------------------------------
function Creative.Permission(Name)
    ...
    -- Se for uma permissão só (string)
    if type(Permission) == "string" then
        return vRP.HasService(Passport, Permission)
    end

    -- Se for lista de permissões (table)
...
-- >>> DAQUI PRA BAIXO, MANTÉM O RESTO DO SEU server.lua ORIGINAL <<<
