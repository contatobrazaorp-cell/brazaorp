...
Location = {
	{
		...
		Coords = vec3(225.49,-1539.85,29.30),
		Mode = "Utensilios"
	}
}
-----------------------------------------------------------------------------------------------------------------------------------------
...
List = {
	...
	Utensilios = {
		...
		Type = "Cash",
		List = {
			-- MOCHILAS (economia do seu Item.lua)
			backpackp = 100000, -- Mochila Pequena (+50Kg)
			backpackm = 150000, -- Mochila Média (+75Kg)
			backpackg = 200000, -- Mochila Grande (+100Kg)
	
			-- REPARO DE MOCHILA (economia do seu Item.lua)
			sewingkit = 50000,
