...
Locations = {
	{
		Logo = "lscustoms.png",
		Permission = "Bennys",
		Coords = vec4(-368.17,-99.29,38.7,348.67),
		Coords = vec4(-368.05,-98.61,38.7,90.71),
		Coords = vec4(-362.21,-100.99,38.7,263.63),
		Coords = vec4(-355.6,-102.8,38.7,141.74),
		Coords = vec4(-349.54,-104.84,38.28,343.0)
